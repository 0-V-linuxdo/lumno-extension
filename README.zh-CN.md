...
<p align="center">Firefox / Zen 移植：<code>0.9.51-firefox-v1.7.0</code></p>
...
1. 下载 [`lumno-0.9.51-firefox-v1.7.0.zip`](https://github.com/0-V-linuxdo/lumno-extension/releases/tag/0.9.51-firefox-v1.7.0) 并解压。
